...
func (s *Store) SaveValidatorStatistics(ctx context.Context, validatorStatistics structs.ValidatorStatistics) error {
	return s.driver.SaveValidatorStatistics(ctx, validatorStatistics)
}
