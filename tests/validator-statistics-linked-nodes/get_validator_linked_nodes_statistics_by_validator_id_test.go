...
func TestGetValidatorLinkedNodesStatisticsByValidatorId(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			req: &http.Request{
				...
				URL: &url.URL{
					RawQuery: "validator_id=test&statistic_type=linked_nodes",
				},
			},
		...
		},
		{
			...
			req: &http.Request{
				Method: http.MethodGet,
				URL: &url.URL{
					RawQuery: "validator_id=2&statistic_type=linked_nodes",
				},
			},
			params: structs.QueryParams{
